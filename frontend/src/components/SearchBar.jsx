    ...
    >
      ...
      {onUseLocation && (
        <button
          ...
          className="p-2.5 rounded-2xl bg-surface/75 backdrop-blur-sm border border-border text-ink/70 hover:text-amber hover:border-amber/40 focus:outline-none focus:ring-2 focus:ring-amber/20 disabled:opacity-50 disabled:cursor-wait transition"
        >
          {isLocating ? (
